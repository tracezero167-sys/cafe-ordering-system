...
export default function MenuClient({ tableId, table, categories, settings, categoryIcons }: MenuClientProps) {
  ...
  useEffect(() => {
    setMounted(true)
    console.log("MenuClient mounted!")
  ...
  const addToCart = (productId: string, name: string, price: number, foodType: string) => {
    console.log("addToCart called:", { productId, name, price, foodType })
  ...
  const Utensils = categoryIcons["Snacks"] || ShoppingBag
